...
From the above component and discriminant plot, we could see that the Ward's method did a much better clustering than the complete linkage. 
    ...
    **Method 2: Jaccard Distance**
    ...
    ```
The Maximum produce very similar results for different agglomerations. Still we compare the Ward's method and the complete linkage here. These two methods vary a lot im the clustering.
